...
# isort: skip_file
# =============================================================================
# VolatilitySystemTrailConfirmLev25：2.5x 杠杆探索（非已证实优势）
#
# 复制自冻结快照 confirm_v1_hyperopt。信号、4.5×ATR 跟踪、300 仓、25%/75% 不变。
# 只改三项以保持 6% 价格止损距离：leverage()=2.5，max_trade_risk=0.15，stoploss=-0.15。
# 15%/2.5 = 12%/2.0 = 6% 价格波动。不搜索其他杠杆。Confirm V1 与前向 Dry-run 保持 2x。
# =============================================================================
...
class VolatilitySystemTrailConfirmLev25(IStrategy):
    """冻结 4.5 规则 + 2.5x。账户风险上限改为 15%，保持 6% 价格止损距离。"""
