...
# isort: skip_file
# =============================================================================
# VolatilitySystemTrailConfirmLev15：15x 杠杆梯度（保持 6% 价格止损距离；非已证实优势）
#
# 完整复制自 VolatilitySystemTrailConfirmLev25。信号、4.5×ATR 跟踪、300 仓、25%/75% 不变。
# 只改三项：leverage()=15.0，max_trade_risk=0.90，stoploss=-0.90。
# 90%/15 = 6% 价格波动，与 2x 的 12%/2.0、2.5x 的 15%/2.5 相同。
...
class VolatilitySystemTrailConfirmLev15(IStrategy):
    """冻结 4.5 规则 + 15x。账户风险上限改为 90%，保持 6% 价格止损距离。"""
