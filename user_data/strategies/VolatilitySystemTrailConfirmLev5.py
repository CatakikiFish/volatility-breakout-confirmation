...
# isort: skip_file
# =============================================================================
# VolatilitySystemTrailConfirmLev5：5x 杠杆梯度（保持 6% 价格止损距离；非已证实优势）
#
# 完整复制自 VolatilitySystemTrailConfirmLev25。信号、4.5×ATR 跟踪、300 仓、25%/75% 不变。
# 只改三项：leverage()=5.0，max_trade_risk=0.30，stoploss=-0.30。
# 30%/5 = 6% 价格波动，与 2x 的 12%/2.0、2.5x 的 15%/2.5 相同。
...
class VolatilitySystemTrailConfirmLev5(IStrategy):
    """冻结 4.5 规则 + 5x。账户风险上限改为 30%，保持 6% 价格止损距离。"""
