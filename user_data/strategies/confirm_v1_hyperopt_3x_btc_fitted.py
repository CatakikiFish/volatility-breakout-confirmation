...
# Tag: confirm_v1_hyperopt_3x_btc_fitted
# BTC 专属 TrailOpt 训练窗最优硬编码：trail_atr_mult=3.6。
# 来源：confirm_v1_hyperopt_3x_btc.py + confirm_v1_hyperopt_3x_btc_trailopt.py
# Hyperopt：20200415-20240829，ProfitDrawDownHyperOptLoss，--spaces exit，
#   --random-state 20260831，-e 100，--min-trades 150，--disable-param-export。
# 归档：strategy_confirm_v1_hyperopt_3x_btc_trailopt_2026-08-31_07-05-09.fthypt
# 训练窗邻居：backtest-result-2026-08-31_07-16-49.zip（3.5 / 3.6 / 3.7）
# 检查窗 AND 失败：20240829-20250829 收益÷回撤 6.04 低于同窗 4.5 的 7.93。
# 不得改选第二名，不得缩窄重搜。本文件只是训练窗冻结记录，不是前向替换件。
#
...
class confirm_v1_hyperopt_3x_btc_fitted(IStrategy):
    """冻结快照：BTC TrailOpt 最优 3.6×ATR + 3x + 540 仓。禁止再搜。"""
