...
# isort: skip_file
# =============================================================================
# RESEARCH — Confirm V3.1 零参数出场 trailclose
#
...
#   完成行 hour % 3 == 2（与 trail3h lookahead 已通过的方法相同）；after_fill 同样更新。
...
# 预注册门槛（与第 10 节相同）：相对同批 V3.1，三窗均盈利、PF≥1.20、清算 0、
# 拒单 0；三窗比值都 ≥ V3.1；检查2 5m 比值 ≥ 同批 V3.1 5m。
# 禁止 Hyperopt。无同名 JSON。
# =============================================================================
...
class confirm_v3_1_BTC_trailclose(IStrategy):
    """V3.1 + 3h 收盘极值 ATR 跟踪（盘中触发）。门槛见文件头。"""
