...
# isort: skip_file
# =============================================================================
# FROZEN — confirm_v3_1_BTC
#
# 母本 1：user_data/strategies/confirm_v3_BTC_noloosen.py（类 confirm_v3_BTC_noloosen）
# SHA-256：e1718c65132a489024c2169b8166caa4b62e22371714f1592625fdb699908667
# 母本 2：user_data/strategies/confirm_v3_BTC_mcap.py（类 confirm_v3_BTC_mcap80 的加仓上限）
# SHA-256：8356ffafb822477a5a4073c01f719799f7ff3f6180a6ed07b93bc5317c428e5f
# 完整复制 noloosen 交易体，不继承任何冻结类；再合并 mcap80 的加仓上限。
#
# 相对 confirm_v3_BTC 只有两条差异：
#   1. 加仓后 after_fill 止损取不放宽一侧（多头 max / 空头 min 与加仓前 trade.stop_loss）。
#   2. 加仓量受 min(首仓×3, max_stake, 0.80×总权益 − 已用保证金) 上限；低于 min_stake 不加。
#
...
class confirm_v3_1_BTC(IStrategy):
    """Confirm V3.1：noloosen 止损 + 80% 合并保证金上限。冻结件。"""
