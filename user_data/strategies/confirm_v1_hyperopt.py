...
# Tag: confirm_v1_hyperopt
# Confirm V1 规则 + 年度1 Hyperopt 最优 trail_atr_mult=4.5（硬编码，无 Parameter、无同名 JSON）。
# 来源探索副本：VolatilitySystemTrailConfirmTrailOpt.py
# Hyperopt：ProfitDrawDownHyperOptLoss，--spaces exit，--random-state 20260830
# 归档：strategy_VolatilitySystemTrailConfirmTrailOpt_2026-08-30_07-39-23.fthypt
# 验证：年度2 07-44-01.zip；两年合并 07-44-32.zip
# Confirm V1 SHA-256：2f96b5c063d37f981c5969440d34cadf7f7d782f01a10192f93cbccd8ed970fc
# 这不是已证实优势，也不是前向 Dry-run 替换件。
# Confirm V1（trail=3.0）与 freqtrade_confirm_fwd 保持不动。
# =============================================================================
...
class confirm_v1_hyperopt(IStrategy):
