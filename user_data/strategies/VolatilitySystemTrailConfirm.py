...
# isort: skip_file
# =============================================================================
# VolatilitySystemTrailConfirm：Trail + 25% 首仓 / 75% 确认加仓（Freqtrade 2026.7）
#
# 主基线：VolatilitySystemTrail（边沿入场 VolatilitySystemTrailEdge 已否决）。
# 冻结黏性入场、2R 启动、0.5R 锁盈、3×ATR 跟踪、初始止损、2x 和总目标仓位。
# 只改仓位拆分：首次突破 proposed_stake/4；第二次独立同向信号补 3×已投入首仓。
# 配置 stake_amount=300 时，首仓 75、加仓 225，合计仍是 300。
# =============================================================================
...
class VolatilitySystemTrailConfirm(IStrategy):
    """Trail + 25% 试探首仓，第二次同向冲击再补 75%。"""
